...
All the code below live in [one](https://github.com/neal-o-r/tube_map) of [two](https://github.com/neal-o-r/tube_interactive) repos
...
<center>
    <embed src="/images/tube/3d.html" width="1200px" height="900px" alt="">
</center>
...
[^6]: All the interactive plots here were made using [Bokeh](https://bokeh.pydata.org/en/latest/)
